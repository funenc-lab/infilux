      ...
      >
        {visibleToasts.map((toast) => {
          ...
          return (
            <Toast.Root
              className={cn(
                'control-floating absolute z-[calc(9999-var(--toast-index))] h-(--toast-calc-height) w-full rounded-lg text-popover-foreground [transition:transform_.35s_cubic-bezier(.22,1,.36,1),opacity_.35s,height_.15s]',
        ...
        {visibleToasts.map((toast) => {
          ...
          return (
            ...
            >
              <Toast.Root
                className={cn(
                  'control-floating relative text-balance text-popover-foreground text-xs transition-[opacity,translate] data-ending-style:translate-y-1 data-starting-style:translate-y-1 data-ending-style:opacity-0 data-starting-style:opacity-0',
