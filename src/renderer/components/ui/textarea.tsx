    ...
    >
      <FieldPrimitive.Control
        render={(defaultProps) => (
          <textarea
            className={cn(
              'field-sizing-content min-h-17.5 w-full rounded-[inherit] px-[calc(--spacing(3)-1px)] py-[calc(--spacing(1.5)-1px)] outline-none focus-visible:outline-none focus-visible:outline-offset-0 focus-visible:shadow-none max-sm:min-h-20.5',
              size === 'sm' &&
