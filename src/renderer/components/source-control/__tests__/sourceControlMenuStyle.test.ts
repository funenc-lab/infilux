...
const commitHistoryListSource = readFileSync(
  resolve(currentDir, '../CommitHistoryList.tsx'),
  'utf8'
);
...
describe('Source control menu style policy', () => {
  it('uses the shared flat control-menu shell for commit history context actions', () => {
    ...
    expect(commitHistoryListSource).toContain("'control-menu fixed z-50 min-w-40 rounded-2xl p-2'");
