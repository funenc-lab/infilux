...
const previewResolve =
  ...
  >();
const nativeSkillDisable =
  vi.fn<(request: { worktreePath: string; sourcePath: string }) => Promise<unknown>>();
const nativeSkillRestore =
  vi.fn<(request: { worktreePath: string; sourcePath: string }) => Promise<unknown>>();
...
function installElectronApi(
  ...
  nativeSkillDisable.mockResolvedValue({
    ok: true,
  ...
  nativeSkillRestore.mockResolvedValue({
    ok: true,
...
describe('ClaudePolicyEditorDialog', () => {
  ...
  beforeEach(() => {
    ...
    nativeSkillDisable.mockReset();
    nativeSkillRestore.mockReset();
  ...
  it('renders the policy search field as an input group with a non-overlapping icon', async () => {
    installElectronApi(
      {
        capabilities: [],
        sharedMcpServers: [],
  ...
  it('shows a success toast after saving project policy changes', async () => {
    ...
    expect(toastAddMock).toHaveBeenCalledWith({
      type: 'success',
      title: 'Policy saved',
      description: 'Project skill and MCP settings were saved.',
    });
  });
  ...
  it('warns when a disabled worktree-native Claude skill may still be auto-loaded', async () => {
    installElectronApi(
      {
        capabilities: [
          {
  ...
  it('quarantines a disabled worktree-native Claude skill from the warning action', async () => {
    installElectronApi(
      {
        capabilities: [
          {
