...
const presetDefinitions: Record<ColorPreset, ThemePresetDefinition> = {
  'graphite-ink': {
    ...
    palettes: {
      light: {
        background: 'oklch(0.978 0.004 242)',
        foreground: 'oklch(0.255 0.012 246)',
        card: 'oklch(0.993 0.002 242)',
        popover: 'oklch(0.996 0.002 242)',
        secondary: 'oklch(0.949 0.006 242)',
        muted: 'oklch(0.957 0.005 242)',
        mutedForeground: 'oklch(0.49 0.01 242)',
        accent: 'oklch(0.922 0.014 242)',
        accentForeground: 'oklch(0.245 0.012 246)',
        primary: 'oklch(0.58 0.045 242)',
        primaryForeground: 'oklch(0.986 0.003 252)',
        support: 'oklch(0.62 0.03 196)',
        supportForeground: 'oklch(0.986 0.003 252)',
        border: 'oklch(0.874 0.008 242)',
        ring: 'oklch(0.654 0.052 242)',
      },
      dark: {
        background: 'oklch(0.165 0.006 242)',
        foreground: 'oklch(0.95 0.004 244)',
        card: 'oklch(0.202 0.007 242)',
        popover: 'oklch(0.214 0.007 242)',
        secondary: 'oklch(0.244 0.008 242)',
        muted: 'oklch(0.232 0.007 242)',
        mutedForeground: 'oklch(0.72 0.008 242)',
        accent: 'oklch(0.296 0.016 242)',
        accentForeground: 'oklch(0.962 0.004 244)',
        primary: 'oklch(0.74 0.05 242)',
        primaryForeground: 'oklch(0.15 0.006 242)',
        support: 'oklch(0.72 0.035 196)',
        supportForeground: 'oklch(0.132 0.006 196)',
        border: 'oklch(0.316 0.01 242)',
        ring: 'oklch(0.784 0.058 242)',
      },
    },
  },
  'tide-blue': {
  ...
  'graphite-red': {
    option: {
      ...
      accentHex: '#4a3f3b',
      supportHex: '#8b7a70',
      swatches: ['#1b1816', '#b86460', '#8b7a70'],
    },
    semanticFamily: 'signal-console',
    palettes: {
      light: {
        background: 'oklch(0.979 0.003 42)',
        foreground: 'oklch(0.288 0.01 34)',
        card: 'oklch(0.994 0.002 42)',
        popover: 'oklch(0.996 0.002 42)',
        secondary: 'oklch(0.951 0.004 40)',
        muted: 'oklch(0.958 0.004 40)',
        mutedForeground: 'oklch(0.506 0.011 36)',
        accent: 'oklch(0.924 0.014 34)',
        accentForeground: 'oklch(0.292 0.01 34)',
        primary: 'oklch(0.594 0.088 24)',
        primaryForeground: 'oklch(0.988 0.002 24)',
        support: 'oklch(0.6 0.02 50)',
        supportForeground: 'oklch(0.988 0.002 24)',
        border: 'oklch(0.882 0.007 40)',
        ring: 'oklch(0.668 0.096 24)',
      },
      dark: {
        background: 'oklch(0.168 0.008 36)',
        foreground: 'oklch(0.946 0.004 40)',
        card: 'oklch(0.204 0.009 36)',
        popover: 'oklch(0.216 0.009 36)',
        secondary: 'oklch(0.248 0.01 36)',
        muted: 'oklch(0.236 0.009 36)',
        mutedForeground: 'oklch(0.716 0.007 36)',
        accent: 'oklch(0.294 0.018 34)',
        accentForeground: 'oklch(0.964 0.004 40)',
        primary: 'oklch(0.714 0.1 22)',
        primaryForeground: 'oklch(0.146 0.008 22)',
        support: 'oklch(0.676 0.022 46)',
        supportForeground: 'oklch(0.126 0.007 46)',
        border: 'oklch(0.314 0.011 36)',
  ...
  'midnight-oled': {
    option: {
      ...
      accentHex: '#41464d',
      supportHex: '#c28a4b',
      swatches: ['#252526', '#8f969f', '#c28a4b'],
    },
    semanticFamily: 'cool-console',
    palettes: {
      light: {
        background: 'oklch(0.952 0.003 250)',
        foreground: 'oklch(0.262 0.01 250)',
        card: 'oklch(0.985 0.002 250)',
        popover: 'oklch(0.989 0.002 250)',
        secondary: 'oklch(0.918 0.004 250)',
        muted: 'oklch(0.93 0.003 250)',
        mutedForeground: 'oklch(0.474 0.008 250)',
        accent: 'oklch(0.888 0.01 250)',
        accentForeground: 'oklch(0.252 0.01 250)',
        primary: 'oklch(0.578 0.022 250)',
        primaryForeground: 'oklch(0.988 0.002 252)',
        support: 'oklch(0.662 0.09 58)',
        supportForeground: 'oklch(0.214 0.012 50)',
        border: 'oklch(0.826 0.006 250)',
        ring: 'oklch(0.656 0.028 250)',
      },
      dark: {
        background: 'oklch(0.185 0.003 250)',
        foreground: 'oklch(0.918 0.006 248)',
        card: 'oklch(0.225 0.003 250)',
        popover: 'oklch(0.24 0.003 250)',
        secondary: 'oklch(0.278 0.004 250)',
        muted: 'oklch(0.262 0.004 250)',
        mutedForeground: 'oklch(0.72 0.006 248)',
        accent: 'oklch(0.33 0.008 250)',
        accentForeground: 'oklch(0.94 0.003 248)',
        primary: 'oklch(0.788 0.028 250)',
        primaryForeground: 'oklch(0.158 0.003 250)',
        support: 'oklch(0.736 0.1 58)',
        supportForeground: 'oklch(0.152 0.003 58)',
        border: 'oklch(0.352 0.005 250)',
        ring: 'oklch(0.832 0.034 250)',
      },
    },
  },
  'classic-red': {
