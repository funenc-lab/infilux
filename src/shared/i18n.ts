...
export const zhTranslations: Record<string, string> = {
  ...
  'No matching worktrees': '\u6ca1\u6709\u5339\u914d\u7684\u5de5\u4f5c\u6811',
  'No live Agent worktrees': '\u6ca1\u6709\u6d3b\u8dc3\u667a\u80fd\u4f53\u5de5\u4f5c\u6811',
  ...
  'Only show live Agent sessions': '仅显示活跃 Agent 会话',
  ...
  'Persistent host recovery is unavailable and this session cannot resume automatically. Start a fresh session to continue.':
    '持久化主机恢复不可用，当前会话无法自动继续。请开启新会话继续。',
  ...
  'Best compatibility fallback': '兼容性最佳的回退方案',
  ...
  'Approve blocked tasks': '\u6279\u51c6\u963b\u585e\u4efb\u52a1',
  'Dispatch ready tasks': '\u5206\u53d1\u5c31\u7eea\u4efb\u52a1',
  'Monitor running tasks': '\u76d1\u63a7\u8fd0\u884c\u4efb\u52a1',
  'Resolve task dependencies': '\u5904\u7406\u4efb\u52a1\u4f9d\u8d56',
  'Stand by': '\u5f85\u547d',
  'High confidence': '\u9ad8\u7f6e\u4fe1\u5ea6',
  'Medium confidence': '\u4e2d\u7b49\u7f6e\u4fe1\u5ea6',
  'Low confidence': '\u4f4e\u7f6e\u4fe1\u5ea6',
  'Ask AI Center': '\u8be2\u95ee AI \u667a\u80fd\u4e2d\u5fc3',
  'Dispatch Plan': '\u6d3e\u53d1\u65b9\u6848',
  'Dispatch Result': '\u6d3e\u53d1\u7ed3\u679c',
  'Started Projects': '\u5df2\u542f\u52a8\u9879\u76ee',
  'Skipped Tasks': '\u5df2\u8df3\u8fc7\u4efb\u52a1',
  '{{count}} projects started': '{{count}} \u4e2a\u9879\u76ee\u5df2\u542f\u52a8',
  '{{count}} skipped': '{{count}} \u4e2a\u5df2\u8df3\u8fc7',
  'No projects started': '\u6682\u65e0\u9879\u76ee\u542f\u52a8',
  'No skipped tasks': '\u6682\u65e0\u8df3\u8fc7\u4efb\u52a1',
  'Project already running': '\u9879\u76ee\u5df2\u5728\u8fd0\u884c',
  'Task not found': '\u4efb\u52a1\u4e0d\u5b58\u5728',
  'Missing worktree': '\u7f3a\u5c11 worktree',
  'Start failed': '\u542f\u52a8\u5931\u8d25',
  'Coordination Signals': '\u534f\u540c\u4fe1\u53f7',
  'cross-project': '\u8de8\u9879\u76ee',
  'agent-coverage': 'Agent \u8986\u76d6',
  intervention: '\u5e72\u9884',
  monitoring: '\u76d1\u63a7',
  'task-splitting': '\u4efb\u52a1\u62c6\u5206',
  'Coordinate cross-project dispatch': '\u534f\u8c03\u8de8\u9879\u76ee\u6d3e\u53d1',
  'Reassign unavailable agent tasks': '\u91cd\u5206\u4e0d\u53ef\u7528 Agent \u7684\u4efb\u52a1',
  'Review intervention queue': '\u590d\u6838\u5e72\u9884\u961f\u5217',
  'Monitor active executions': '\u76d1\u63a7\u6b63\u5728\u6267\u884c\u7684\u4efb\u52a1',
  ...
  '{{count}} risks': '{{count}} \u4e2a\u98ce\u9669',
  high: '\u9ad8',
  medium: '\u4e2d',
  low: '\u4f4e',
  'Blocked tasks need intervention': '\u963b\u585e\u4efb\u52a1\u9700\u8981\u5e72\u9884',
  'Some assigned agents are unavailable': '\u90e8\u5206\u6307\u5b9a Agent \u4e0d\u53ef\u7528',
  'Running task state is detached from auto-execute state':
    '\u8fd0\u884c\u4efb\u52a1\u72b6\u6001\u4e0e\u81ea\u52a8\u6267\u884c\u72b6\u6001\u8131\u8282',
  Dispatch: '\u5206\u53d1',
  'No interventions': '\u65e0\u9700\u5e72\u9884',
  'No running tasks': '\u6682\u65e0\u8fd0\u884c\u4efb\u52a1',
  'No deferred tasks': '\u6682\u65e0\u5ef6\u540e\u4efb\u52a1',
