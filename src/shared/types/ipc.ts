...
export const IPC_CHANNELS = {
  ...
  FILE_SAVE_CLIPBOARD_IMAGE_TO_TEMP: 'file:save-clipboard-image-to-temp',
  ...
  SESSION_OUTPUT_RESYNC: 'session:outputResync',
  ...
  APP_LIST_SYSTEM_FONT_FAMILIES: 'app:listSystemFontFamilies',
